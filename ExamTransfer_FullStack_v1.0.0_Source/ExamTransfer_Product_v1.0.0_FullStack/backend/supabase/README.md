...
2. For local validation, run `supabase start`, `supabase db reset`, and `supabase test db`. For production, follow `docs/production-update-checklist.md`; the legacy direct-push script is disabled.
