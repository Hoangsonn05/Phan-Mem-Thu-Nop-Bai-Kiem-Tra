...
internal static class StudentSpreadsheetParser
{
    private static readonly string[] StudentCodeAliases =
        ["ma sinh vien", "ma sv", "masv", "student code", "studentcode"];
    ...
    private static string NormalizeHeader(string value)
    {
        ...
        // Unicode FormD loại được dấu thanh nhưng không chuyển chữ đ/Đ thành d/D.
        // Chuyển riêng chữ đ để tiêu đề "Họ đệm" khớp alias "ho dem".
        value = value
            .Replace('\u00A0', ' ')
            .Replace('Đ', 'D')
            .Replace('đ', 'd');
