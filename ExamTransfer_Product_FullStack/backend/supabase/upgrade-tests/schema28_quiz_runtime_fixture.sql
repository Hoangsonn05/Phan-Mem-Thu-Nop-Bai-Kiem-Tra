...
begin
  if (select max(version) from supabase_migrations.schema_migrations)
     ...
     or (select schema_version from public.examtransfer_cloud_meta where id=1)
       <> 28 then
    raise exception 'SCHEMA28_FIXTURE_WRONG_MIGRATION_TARGET';
  end if;
end
$fixture_precondition$;

insert into auth.users(id,email) values
  ('92000000-0000-0000-0000-000000000001','schema28-teacher@example.test')
on conflict (id) do nothing;
insert into public.organizations(id,name) values
  ('92100000-0000-0000-0000-000000000001','Schema 28 Quiz Runtime Org');
insert into public.profiles(
  id,organization_id,display_name,role,username,is_active)
values (
  '92000000-0000-0000-0000-000000000001',
  '92100000-0000-0000-0000-000000000001',
  'Schema 28 Teacher','Teacher','schema28-teacher',true);
...
values (
  ...
  '92100000-0000-0000-0000-000000000001',
  'Schema 28 Class','S28','2026','Active','Public',
...
values (
  ...
  '92100000-0000-0000-0000-000000000001',
  '92200000-0000-0000-0000-000000000001',
  'Schema 28 Quiz','Test',30,'Published',1,
  '92000000-0000-0000-0000-000000000001',
...
values (
  ...
  'Schema 28 preserved question',10,false);
...
begin
  if (select count(*) from public.quiz_questions
    ...
    raise exception 'SCHEMA28_QUIZ_FIXTURE_LOAD_FAILED';
  end if;
end
$fixture_loaded$;
